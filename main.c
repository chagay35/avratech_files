...
bool (*chekArr[6])(char[]);
//=== vaidation functions, in diffrent file ===
...
bool badDate(char[]);
//=== query functions, in diffrent file ===
...
int main(int argc, char *argv[])
{
    ...
    chekArr[4]=badDebt;
    chekArr[5]=badDate;
    bool fileOk = readfile(argv[1]);//path came from arguments' vector
